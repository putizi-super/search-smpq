...
from module.brecq.recon_layer import layer_reconstruction
from module.brecq.recon_block import block_reconstruction
from module.brecq.brecq_layer import QuantModule
from module.brecq.brecq_block import BaseQuantBlock
from module.brecq.brecq_model import QuantModel
...
def main():
    ...
    ### qnn的weight量化状态设置为true activation的量化状态设置为false
